...
Resultado:
✅ my-app-1 — running:healthy
✅ my-app-2 — running:healthy
❌ my-app-3 — exited:unhealthy
✅ my-app-4 — running:unknown
...
```
...
```
Hermes: Reinicia my-app-3

Resultado:
🔍 Buscando my-app-3...
UUID: xxxxxxxx...
🔄 Reiniciando my-app-3...
✅ my-app-3 reiniciada correctamente
```
